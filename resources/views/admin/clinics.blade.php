...
<div class="container-fluid main-container" style="height: 80vh;">
    ...
    <div class="col-md-10 content" style="margin-top: 20px">
                    ...
                    @foreach($clinics as $clinic)
                        <li class="list-group-item">
                            ...
                            <span class="pull-right" style="display: inline-block;">
                                <form style="display: inline-block;" role="form" method="POST" action="{{route('admin.clinics.destroy')}}" autocomplete="off">
                                    {{ csrf_field() }}
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-signin" role="form" method="POST" action="{{route('admin.clinics.store')}}" autocomplete="off">
                    {{ csrf_field() }}
