...
<?php $__env->startSection('content'); ?>
    <form class="form-signin" role="form" method="POST" action="<?php echo e(route('reservations.update', $reservation->id)); ?>" style="margin-top: 50px"  autocomplete="off">
        ...
        <div class="d-flex justify-content-between align-items-center p-3 my-3 bg-purple rounded shadow-sm bordered">
            <div class="m-3 date" data-provide="datepicker">
                ...
                <input readonly type="text" class="form-control" name="date" data-today-byn="true" data-today-highlight="true" id="date" value="<?php echo e($reservation->date); ?>">
            ...
            <div class="m-3">
                ...
                <textarea type="text"  id="notes" class="form-control" placeholder="Notes" name="notes"><?php echo e($reservation->notes); ?></textarea>
            </div>
        </div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/treatment_easier/resources/views/reservations/edit.blade.php ENDPATH**/ ?>