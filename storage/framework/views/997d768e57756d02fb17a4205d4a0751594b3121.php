...
<div class="container-fluid main-container" style="height: 80vh;">
    ...
    <div class="col-md-10 content" style="margin-top: 20px">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form class="form-signin" role="form" method="POST" action="<?php echo e(route('admin.clinics.store')); ?>" autocomplete="off">
                    <?php echo e(csrf_field()); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/treatment_easier/resources/views/admin/clinics.blade.php ENDPATH**/ ?>